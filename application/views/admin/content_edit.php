			...
			<div class="UIContentSection">
				<fieldset>
					<table class="UILegend">
						<tr>
							<td class="UILegendTitle"><?php if ($editexisting) echo "Edit"; else echo "Add"; ?> Content</td>
							<td class="UILegendActions"><?php if ($editexisting) { ?><a href="<?php echo $baseurl; ?>toolbox/delete/content/<?php echo $content['id']; ?>/confirm">Delete</a><?php } ?></td>
						</tr>
					</table>
