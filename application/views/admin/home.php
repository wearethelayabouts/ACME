...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en" xml:lang="en">
	...
	<body>
		...
		<ul class="smallmainbox">
			...
			<li><a href="<?=$baseurl?>toolbox/files/">Files</a></li>
			<li><a href="<?=$baseurl?>toolbox/categories/">Categories</a></li>
			<li><a href="<?=$baseurl?>toolbox/users/">Users</a></li>
			<li><a href="<?=$baseurl?>toolbox/user_fields/">User Fields</a></li>
			<li><a href="<?=$baseurl?>toolbox/author_roles/">Author Roles</a></li>
			<li><a href="<?=$baseurl?>toolbox/news/">News</a></li>
			<li><a href="<?=$baseurl?>toolbox/pages/">Pages</a></li>
		</ul>
